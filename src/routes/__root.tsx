...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "InboxTokens — Every token you receive becomes yield" },
      { name: "description", content: "InboxTokens uses EIP-7702 delegation, Uniswap v4 hooks, and Morpho vaults to auto-convert incoming tokens into USDC yield instantly." },
      { name: "author", content: "InboxTokens" },
      { property: "og:title", content: "InboxTokens — Every token you receive becomes yield" },
      { property: "og:description", content: "InboxTokens uses EIP-7702 delegation, Uniswap v4 hooks, and Morpho vaults to auto-convert incoming tokens into USDC yield instantly." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@InboxTokens" },
      { name: "twitter:title", content: "InboxTokens — Every token you receive becomes yield" },
      { name: "twitter:description", content: "InboxTokens uses EIP-7702 delegation, Uniswap v4 hooks, and Morpho vaults to auto-convert incoming tokens into USDC yield instantly." },
