...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "InboxTokens — Programmable Ethereum receive layer" },
      { property: "og:description", content: "Auto-convert incoming tokens into yield-bearing USDC with EIP-7702 + Uniswap v4 hooks + Morpho." },
